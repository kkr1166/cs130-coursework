...
const getAlbums = (term) => {
    ...
    fetch(url)
        ...
        .then(data => {
            if (data.length === 0) {
                document.getElementById('albums').innerHTML = "No albums match search!";
                ...
                const template = `
                    <section class="album-card" id="${album.id}">
                        <div>
                            ...
                            <h3>${album.name}</h3>
                            <div class="footer">
                                <a href="${album.spotify_url}" target="_blank">view on spotify
                                </a>
                            </div>
                        </div>
                    </section>`;
...
const getArtist = (term) => {
    ...
    fetch(url)
        ...
        .then(data => {
            ...
            if (data.length === 0) {
                document.getElementById('artist').innerHTML = "No artists match search!";
